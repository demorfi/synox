 ...
 * For download torrent files to kinozal.tv.
 *
...
class SynoFileHostingKinozal
{
     ...
     * @access private
     */
    private $loginUrl = 'http://kinozal.tv/takelogin.php';
     ...
     * @access private
     */
    private $cookiePath = '/tmp/kinozal.cookie';
     ...
     * @access private
     */
    private $logsPath = '/tmp/ht-kinozal.log';
    ...
    private function loginAccount($username, $password)
    {
        ...
        return (strpos($content, 'my.php') !== false && file_exists($this->cookiePath));
    }
