 ...
 * For download torrent files to pornolab.net.
 *
...
class SynoFileHostingPornolab
{
     ...
     * @access private
     */
    private $loginUrl = 'http://pornolab.net/forum/login.php';
     ...
     * @access private
     */
    private $cookiePath = '/tmp/ht-pornolab.cookie';
     ...
     * @access private
     */
    private $logsPath = '/tmp/ht-pornolab.log';
